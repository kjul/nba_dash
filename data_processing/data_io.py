...
def aggregate_seasons_for_plotting(df):
    """
    Args:
        df (pandas data frame): season totals data frame (either regular season or postseason)

    Returns:
        pandas data frame: season totals data frame aggregated for easy plotting.
    """
